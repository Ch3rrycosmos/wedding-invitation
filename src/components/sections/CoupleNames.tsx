  ...
  return (
    <SectionWrapper id="couple" tone="cream" className="min-h-[80vh]">
      <div className="flex flex-col items-center justify-center gap-8 text-center">
        <ScrollReveal>
          <Monogram text={weddingConfig.coupleMonogram} size={128} />
        </ScrollReveal>

        <div className="flex flex-col items-center gap-2">
          <h1 className="font-playfair text-5xl font-semibold tracking-wide text-emerald sm:text-7xl md:text-8xl">
            <LetterReveal text={weddingConfig.bride} />
          </h1>
          <ScrollReveal delay={0.5}>
            <span className="font-great-vibes text-4xl text-gold sm:text-5xl">&amp;</span>
          </ScrollReveal>
          <h1 className="font-playfair text-5xl font-semibold tracking-wide text-emerald sm:text-7xl md:text-8xl">
